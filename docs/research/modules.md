...
| R-INGRESS: durable acquisition and scheduling | RQ-005; T-014/T-008 | Short Python/C++ SQLite and MCAP recorders passed 10 Hz replay; current processing still falls behind and no live source or scheduler exists. | Source ack/retry and failure contract, long-run durable-write and checkpoint tails, bounded ordered scheduler, backlog/disk and output-age gates, recovery evidence. See experiment 0008. |
